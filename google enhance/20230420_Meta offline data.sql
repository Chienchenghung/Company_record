...
inner join bi_edw..DimMediaDetail as c with(nolock) on a.market_media_key=c.MediaKey and c.L2_CNAME in (N'tutorJr部落格', N'Blog', N'Facebook Ads_adGeek', N'Facebook Ads_JS', N'KOL', N'部落客')
